    ...
    <div>
      <div className='About'>
        ...
        <p className='AboutBody'>
          I'm Chinonso Nwabueze, A software engineer currently based in Nigeria. Who loves turning ideas from thought to reality.I specialize in creating functional user interfaces and making the user experience as comfortable as possible.<br/><br/>
