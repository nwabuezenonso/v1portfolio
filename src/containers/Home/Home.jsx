  ...
  return (
    <div className='intro'>
      <div className='intro_text'>
        ...
        <p className='introText_content'> I’m a Software Engineer who loves writing code. i like building applications with user friendly interactions and delivering solutions that drives business growth using modern web technology.</p>
        <div id='resume'>
